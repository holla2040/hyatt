...
void settings_restore(uint8_t restore_flag) {  
  if (restore_flag & SETTINGS_RESTORE_DEFAULTS) {
    ...
    settings.hyatt_zero_offset_x = 0;
    settings.hyatt_zero_offset_y = 0;
...
uint8_t settings_store_global_setting(uint8_t parameter, float value) {
  // hyatt need to skip this test for hyatt_zero_offset_x,y
  if ((parameter != 33) && (parameter != 34)) {
  ...
  if (parameter >= AXIS_SETTINGS_START_VAL) {
    ...
    switch(parameter) {
      ...
      case 32:
        ...
        #endif
        break;
      case 33: settings.hyatt_zero_offset_x = value; break;
      case 34: settings.hyatt_zero_offset_y = value; break;
      default: 
